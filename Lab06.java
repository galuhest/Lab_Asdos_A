	...
	public static void main(String[] args) {
		...
		while (input.hasNext()) {
			...
			if (inputSplit.nextToken().equalsIgnoreCase("Beli")) {
				...
				farmer.buyAyam(nama);
				System.out.println(farmer.getNama() + " membeli ayam bernama " + nama);
				System.out.println("Uang " + farmer.getNama() + " sekarang: " + farmer.getMoney() + " G");
				...
				System.out.println(farmer.getNama() + " mengupgrade kandang. Kapasitas baru : " + farmer.getKandang().size());
